export function MethodologyDisclosure(): JSX.Element {
  return (
    <section className="eldar-panel rounded-2xl p-4">
      <details open>
        <summary className="cursor-pointer text-[10px] uppercase tracking-[0.12em] text-white/60">
        ...
        <div className="mt-3 space-y-3 text-xs text-white/75">
          ...
          <div>
            ...
            <p>Return, Risk, Drawdown, Diversification, Implementability, and ELDAR Alpha Tilt are each scored 0–100 and weighted.</p>
          </div>
          <div>
