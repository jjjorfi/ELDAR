  ...
  return (
    <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
      <div className="min-w-0">
        ...
        <h1 className="mt-2 text-3xl font-semibold tracking-[-0.04em] text-white md:text-[2.5rem]">{title}</h1>
        {subtitle ? <p className="mt-2 max-w-2xl text-sm leading-6 text-white/60">{subtitle}</p> : null}
      </div>
